...
$utic=new  wishC();
$prod=$utic->afficherwich_list_user();
                        ...
                        <ul class="navbar-nav flex-column">
                            ...
                            <li class="nav-item">
                                ...
                                <div id="submenu-5" class="collapse submenu" style="">
                                    <ul class="nav flex-column">
                                        <li class="nav-item">
                                            <a class="nav-link" href="affichewich.php">Wish list</a>
                                        </li>
                                        <li class="nav-item">
                    ...
                    <div class="ecommerce-widget">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-9 col-lg-12 col-md-6 col-sm-12 col-12">
                                <div class="card">
                                    <h5 class="card-header">Wish list</h5>
...
?>
                                   ...
                                   <td>     <form method="post" action="supprumerwish.php">
<input type="submit" value="Supprimer"class="btn btn-primary btn-lg" >
<input type="hidden" value="<?php echo $pro['id_wich'] ?>" name="id_wich">
</form></td>
